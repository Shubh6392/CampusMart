...
export default function ListingCard({ id, title, price, category, condition, image, campus, isDemo }: ListingCardProps) {
  const card = (
    <div className={`group elevated-card flex h-full overflow-hidden ${isDemo ? 'cursor-default' : 'elevated-card-hover cursor-pointer'}`}>
      ...
      <div className="flex flex-1 flex-col space-y-4 p-5">
        ...
        <div className="mt-auto border-t border-slate-100 pt-4 dark:border-white/10">
          ...
          {!isDemo && (
            <div className="mt-4 flex items-center justify-between text-xs font-black uppercase tracking-[0.14em] text-slate-400 dark:text-slate-500">
